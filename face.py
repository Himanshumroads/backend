...
class Face:
    def __init__(self, app):
        ...
        self.face_user_keys = {}
        self.load_all() # load all face encodings of the images we have in the database
    #1. to get the user details using index key
